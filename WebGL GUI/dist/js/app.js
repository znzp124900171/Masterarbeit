/*! GUI app.js
 * ================
 * Main JS application file for GUI v2. This file
 * should be included in all pages. It controls some layout
 * options and implements exclusive GUI plugins.
 *
...
function _init() {
   ...
   *
   * @type Object
   * @usage $.GUI.boxWidget.activate()
   *        Set all your options in the main $.GUI.options object
   */
  $.GUI.boxWidget = {
    selectors: $.GUI.options.boxWidgetOptions.boxWidgetSelectors,
    icons: $.GUI.options.boxWidgetOptions.boxWidgetIcons,
    animationSpeed: $.GUI.options.animationSpeed,
...
(function ($) {
  ...
  $.fn.activateBox = function () {
    $.GUI.boxWidget.activate(this);
  };

  $.fn.toggleBox = function () {
    var button = $($.GUI.boxWidget.selectors.collapse, this);
    $.GUI.boxWidget.collapse(button);
  };

  $.fn.removeBox = function () {
    var button = $($.GUI.boxWidget.selectors.remove, this);
    $.GUI.boxWidget.remove(button);
  };
